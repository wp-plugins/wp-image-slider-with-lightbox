...
2. Add wordpress featured image in slider directly from post/page add/edit.

3. 16 Slider Easing Effects(select your desired slider easing effect).

4. show/hide lightbox caption for particular image lightbox.

5. No advertisements.

6. New Field Added Image Description.If image description set it will added to lightbox image caption.

7. New Field Added Image Order,Now admin can display slider according image order.

8. New Field added open image link in new tab or same tab.The link will be added into lightbox image title
